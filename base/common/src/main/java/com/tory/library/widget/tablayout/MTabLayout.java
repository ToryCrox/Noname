...
public class MTabLayout extends HorizontalScrollView {
     ...
     * MTabLayout}. This will only take effect if the indicator height is set via the custom indicator
     ...
     * width of the {@link MTabLayout}. This will disregard {@code tabIndicatorHeight} and the
    ...
    public MTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MTabLayout, defStyleAttr,
                R.style.MTabLayoutStyle);
    ...
    /**
     * Add a {@link MTabLayout.OnTabSelectedListener} that will be invoked when tab selection changes.
     *
    ...
    /**
     * Add a {@link MTabLayout.BaseOnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via {@link
    ...
    /**
     * Remove the given {@link MTabLayout.OnTabSelectedListener} that was previously added via {@link
    ...
    /**
     * Remove the given {@link MTabLayout.BaseOnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link MTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Set the indicator gravity used to align the tab selection indicator in the {@link MTabLayout}.
     ...
     * indicator height and stretch across the entire height and width of the {@link MTabLayout}. This
    ...
    /**
     * Set whether this {@link MTabLayout} will have an unbounded ripple effect or if ripple will be
    ...
    /**
     * Returns whether this {@link MTabLayout} has an unbounded ripple effect, or if ripple is bound to
     * the tab item size.
     *
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabUnboundedRipple
    ...
    /**
     * A {@link LinearLayout} containing {@link Tab} instances for use with {@link MTabLayout}.
     */
    public final class TabView extends LinearLayout {
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                MTabLayout.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
            }
        }
     ...
     * provided {@link MTabLayout} so that the tab position is kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull
        private final WeakReference<MTabLayout> tabLayoutRef;
        ...
        public void onPageScrolled(
            ...
            final MTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link MTabLayout.OnTabSelectedListener} class which contains the necessary calls back to the
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (MTabLayout.this.viewPager == viewPager) {
