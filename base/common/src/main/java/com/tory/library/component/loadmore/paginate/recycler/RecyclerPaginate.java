...
public final class RecyclerPaginate extends Paginate {
    ...
    public int getLoadMoreAppearTimes() {
        ...
        return wrapperAdapter.getLoadMoreAppearTimes();
    }

    @Override
    public void resetLoadMoreAppearTimes(int i) {
        wrapperAdapter.resetLoadMoreAppearTimes(i);
    }
    ...
    void checkEndOffset() {
        ...
        if (recyclerView.getLayoutManager() instanceof VirtualLayoutManager) {
            firstVisibleItemPosition = ((VirtualLayoutManager) recyclerView.getLayoutManager()).findFirstVisibleItemPosition();
    ...
    public static class Builder {
         ...
         * @see {@link#(LoadingListItemCreator)}
         */
