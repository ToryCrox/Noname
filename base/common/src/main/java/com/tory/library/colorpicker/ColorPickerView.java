...
public class ColorPickerView extends View {
    ...
    private boolean moveTrackersIfNeeded(MotionEvent event) {
        ...
        if (mHueTouchRect.contains(startX, startY)) {
            mLastTouchedPanel = PANEL_HUE;

            mHue = pointToHue(event.getY());

            update = true;
        } else if (mSatValTouchRect.contains(startX, startY)) {
            ...
            update = true;
        } else if (mAlphaTouchRect != null && mAlphaTouchRect.contains(startX, startY)) {
    ...
    private void setUpSatValRect() {
        ...
        float panelWidth = dRect.width() - BORDER_WIDTH_PX * 4 - HUE_PANEL_WIDTH - PANEL_SPACING;
        float panelHeight = dRect.height() - BORDER_WIDTH_PX * 2;
        if (mShowAlphaPanel) {
            panelHeight -= PANEL_SPACING + ALPHA_PANEL_HEIGHT;
        }
        ...
        mSatValTouchRect = new RectF(mSatValRect);
        mSatValTouchRect.inset(-mDrawingOffset * 0.8f, -mDrawingOffset * 0.8f);
    }
    ...
    private void setUpHueRect() {
        ...
        mHueTouchRect = new RectF(mHueRect);
        mHueTouchRect.inset(0, -mDrawingOffset * 0.8f);
    }
    ...
    private void setUpAlphaRect() {
        ...
        mAlphaTouchRect = new RectF(mAlphaRect);
        mAlphaTouchRect.inset(-mDrawingOffset * 0.8f, 0);
