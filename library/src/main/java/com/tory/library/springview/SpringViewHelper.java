...
public class SpringViewHelper {

    private static final String TAG = "SpringViewHelper";
    private static final boolean ENABLE_LOG_V = BuildConfig.DEBUG;

    protected static final int HORIZONTAL = SpringScrollable.HORIZONTAL;
    protected static final int VERTICAL = SpringScrollable.VERTICAL;
    ...
    protected SpringScrollable mSpringView;


    public SpringViewHelper(@NonNull ViewGroup view) {
        mView = view;
        if(!(view instanceof SpringScrollable)){
            throw new RuntimeException("SpringViewHelper init view must implement SpringScrollable");
        }
        mSpringView = (SpringScrollable) view;
    }
     ...
     * @param orientation
     */
    public void setOrientation(@SpringScrollable.Orientation int orientation){
