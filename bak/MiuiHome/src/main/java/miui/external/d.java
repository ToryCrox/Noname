...
class d {
    ...
    private static void a(Object obj, Object obj2, String str) throws NoSuchFieldException, IllegalAccessException, ClassNotFoundException {
        if (VERSION.SDK_INT >= 23) {
            b(obj, obj2, "nativeLibraryPathElements");
        } else {
            b(obj, str);
        }
    }

    private static void b(Object obj, Object obj2, String str) throws NoSuchFieldException, IllegalAccessException, ClassNotFoundException {
        Object[] objArr = (Object[]) a(obj2, str).get(obj2);
        Field a = a(obj, str);
    ...
    private static void b(Object obj, String str) throws NoSuchFieldException, IllegalAccessException {
        Field a = a(obj);
